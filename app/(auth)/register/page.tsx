  ...
  return (
    <section className="flex min-h-screen items-center justify-center bg-base px-4 py-10">
      <div className="w-full max-w-md rounded-card border border-white/10 bg-surface p-6 shadow-manga">
        <h1 className="mb-2 font-display text-5xl tracking-[-0.03em] text-text-primary">Inscription</h1>
        <p className="mb-6 font-body text-sm leading-[1.7] text-text-secondary">
          Crée ton identité manga et personnalise ton profil en quelques secondes.
        </p>

        <form className="space-y-4">
          <label className="block space-y-2">
            <span className="font-ui text-xs uppercase tracking-[0.08em] text-text-secondary">Username</span>
            <input
              type="text"
